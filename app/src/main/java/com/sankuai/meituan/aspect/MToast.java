 ...
 * 精简版toast
 * <p>
 * 用于aspect中对原生toast的替换，作为无系统通知权限时的替补方案
 * <p>
 * setText&makeText&cancel方法暂时用不到，已被注释
 * <p>
...
//    public static MToast makeText(Context context, String text, long duration){
...
//    }
    ...
    MToast setGravity(int gravity, int xOffset, int yOffset) {
    ...
    MToast setDuration(long durationMillis) {
        if (durationMillis < 0) {
            mDurationMillis = 0;
        }
    ...
    MToast setView(View view) {
        mView = view;
        return this;
    }

    MToast setMargin(float horizontalMargin, float verticalMargin) {
