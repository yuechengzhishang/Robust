...
import static com.android.build.gradle.internal2.incremental.InstantRunVerifierStatus.CLASS_ANNOTATION_CHANGE;
import static com.android.build.gradle.internal2.incremental.InstantRunVerifierStatus.COMPATIBLE;
import static com.android.build.gradle.internal2.incremental.InstantRunVerifierStatus.FIELD_ADDED;
import static com.android.build.gradle.internal2.incremental.InstantRunVerifierStatus.FIELD_REMOVED;
import static com.android.build.gradle.internal2.incremental.InstantRunVerifierStatus.FIELD_TYPE_CHANGE;
import static com.android.build.gradle.internal2.incremental.InstantRunVerifierStatus.IMPLEMENTED_INTERFACES_CHANGE;
...
import static com.android.build.gradle.internal2.incremental.InstantRunVerifierStatus.R_CLASS_CHANGE;
import static com.android.build.gradle.internal2.incremental.InstantRunVerifierStatus.STATIC_INITIALIZER_CHANGE;
...
//        classFile.name.startWith("")
    ...
    public static List<InstantRunVerifierStatus> runByClassNode(ClassNode originalClass, ClassNode updatedClass)
            throws IOException {
...
//        }
        ...
        InstantRunVerifierStatus fieldChange = verifyFields(originalClass, updatedClass);
        if (fieldChange != COMPATIBLE) {
            statuses.add( fieldChange);
        }

        statuses.add( verifyMethods(originalClass, updatedClass));
        return statuses;
    }
    ...
    public static class MethodNodeComparator implements Comparator<MethodNode> {
