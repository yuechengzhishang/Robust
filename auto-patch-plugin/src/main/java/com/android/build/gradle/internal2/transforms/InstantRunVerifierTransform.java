...
package com.android.build.gradle.internal2.transforms;
...
//        }
    ...
    @NonNull
    public static InstantRunVerifierStatus processChangedJar(JarFile backupJar, JarFile newJar)
            throws IOException {
        ...
        while (jarEntries.hasMoreElements()) {
            ...
            if (jarEntry.getName().startsWith("javassist")){
                continue;
            }
    ...
    @VisibleForTesting
    @NonNull
    protected static InstantRunVerifierStatus runVerifier(String name,
